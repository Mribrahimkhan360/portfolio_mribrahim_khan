                            ...
                            <ul class="brower-states">
                                <li class="brower-item">
                                    <div class="browser-image">
                                        <img src="{{asset('/')}}admin/assets/images/brower-image/chrome.png" class="img-fluid"
                                             alt="">
                                        <h5>Chrome</h5>
                                    </div>
                                ...
                                <li class="brower-item">
                                    <div class="browser-image">
                                        <img src="{{asset('/')}}admin/assets/images/brower-image/firefox.png" class="img-fluid"
                                             alt="">
                                        <h5>Firefox</h5>
                                    </div>
                                ...
                                <li class="brower-item">
                                    <div class="browser-image">
                                        <img src="{{asset('/')}}admin/assets/images/brower-image/opera.png" class="img-fluid"
                                             alt="">
                                        <h5>Opera Mini</h5>
                                    </div>
                                ...
                                <li class="brower-item">
                                    <div class="browser-image">
                                        <img src="{{asset('/')}}admin/assets/images/brower-image/safari.png" class="img-fluid"
                                             alt="">
                                        <h5>Safari</h5>
                                    </div>
