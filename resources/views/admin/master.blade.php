...
<head>
    ...
    <meta name="description" content="Voxo admin is super flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
    <meta name="keywords"
            ...
            <div>
                <div class="logo-wrapper logo-wrapper-center">
                    <a href="{{route('dashboard')}}" data-bs-original-title="" title="">
                        <img class="img-fluid for-dark" src="{{asset('/')}}admin/assets/images/logo/logo-white.png" alt="">
                    </a>
                    <div class="back-btn">
                        ...
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li>
                                        <a href="{{route('banner.manage')}}">Mangae Banner</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="{{route('biography.add')}}">Add Biography</a>
                                    </li>
                                    <li>
                                        <a href="{{route('biography.manage')}}">Mangae Biography</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sidebar-list">
                            ...
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="{{route('banner.add')}}">Add Blog</a>
                                    </li>
                                    <li>
                                        <a href="order-detail.html">Manage Blog</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="order-list.html">Add Contact</a>
                                    </li>
                                    <li>
                                        <a href="order-detail.html">Manage Contact</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="order-list.html">Add Portfolio</a>
                                    </li>
                                    <li>
                                        <a href="order-detail.html">Manage Portfolio</a>
                                    </li>
                                </ul>
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="order-list.html">Add Service</a>
                                    </li>
                                    <li>
                                        <a href="order-detail.html">Manage Service</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
